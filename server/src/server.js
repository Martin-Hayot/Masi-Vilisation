...
var db_1 = __importDefault(require("./repositories/db"));
var logger_1 = __importDefault(require("./utils/logger"));
var server = app_1.default.listen(config_1.default.port, function () {
    logger_1.default.info("Server running on port ".concat(config_1.default.port, " in ").concat(config_1.default.nodeEnv, " mode"));
});
        ...
        server.close(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        logger_1.default.error('Error during shutdown:', err_1);
                        process.exit(1);
                        return [3 /*break*/, 3];
